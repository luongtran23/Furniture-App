...
import axios from 'axios';
 ...
 const validateYupSchema = Yup.object().shape({
  ...
  .required('Required'),
  username:Yup.string()
  .min(3, 'Provide a value username')
  .required('Required')
});
...
const SignUp = ({navigation}) => {
  ...
  const registerUser = async(values)=>{
    setLoader(true);
    try {
      const endpoint ='http://192.168.8.109:3000/api/register';
      const data = values;
              ...
              <View>
                <View style={styles.wrapper}>
                  ...
                  {touched.username && errors.username && (
                    <Text style={styles.errorsMesage}>{errors.usernames}</Text>
                  )}
                </View>
                ...
                <View style={styles.wrapper}>
                  ...
                  {touched.location && errors.location && (
                    <Text style={styles.errorsMesage}>{errors.location}</Text>
                  )}
                </View>
